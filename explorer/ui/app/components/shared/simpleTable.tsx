                ...
                return (
                  ...
                  >
                    {header.isPlaceholder ? null : (
                      <div>
                        <span className='text-b-sm text-start'>{flexRender(header.column.columnDef.header, header.getContext())}</span>
            ...
            return (
              <tr key={row.id}>
                {row.getVisibleCells().map((cell, cellIndex) => {
                  return (
                    <td key={cell.id} className={`px-4 py-2 whitespace-nowrap ${cellIndex < 3 && 'table-highlight'} ${cellIndex === 0 && 'text-center'}`} role="cell">
                      <Link
